# Generated by Django 3.2.16 on 2026-01-21 15:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("id", models.CharField(blank=True, max_length=24, null=True)),
                (
                    "type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="state.nodetype"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "child",
                    models.ForeignKey(
                        on_delete=models.SET(state.models.removed_node),
                        related_name="events_as_child",
                        to="state.node",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        default=state.models.default_edge_type,
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="links_to_children",
                        to="state.node",
                    ),
                ),
            ],
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("type", "id"), name="unique_type_id_combination"
            ),
        ),
        migrations.AddIndex(
            model_name="edge",
