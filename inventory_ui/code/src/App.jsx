...
import { AllocationPage } from './pages/allocations';
...
import { NewStockPage } from './pages/new_stock';
  ...
  return (
    <Routes>
      <Route path='/' element={<Base {...props}/>}>
        ...
        <Route path="/allocate" element={<AllocationPage {...props}/>} />
        <Route path="/new-stock" element={<NewStockPage {...props}/>} />
